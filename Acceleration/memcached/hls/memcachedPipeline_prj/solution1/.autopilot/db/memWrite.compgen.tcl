...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 54 \
    name addressAssignDramIn_s \
    reset_level 1 \
    sync_rst true \
    corename {} \
    metadata {  } \
    op interface \
    ports { addressAssignDramIn_s_TVALID { I 1 bit } addressAssignDramIn_s_TDATA { I 32 vector } addressAssignDramIn_s_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'addressAssignDramIn_s'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 55 \
    name addressAssignFlashIn \
    reset_level 1 \
    sync_rst true \
    corename {} \
    metadata {  } \
    op interface \
    ports { addressAssignFlashIn_TVALID { I 1 bit } addressAssignFlashIn_TDATA { I 32 vector } addressAssignFlashIn_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'addressAssignFlashIn'"
}
}
...
eval "cg_default_interface_gen_dc { \
    id 60 \
    name comp2memWrStatus_V_b \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_comp2memWrStatus_V_b \
    op interface \
    ports { comp2memWrStatus_V_b_dout { I 8 vector } comp2memWrStatus_V_b_empty_n { I 1 bit } comp2memWrStatus_V_b_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 61 \
    name comp2memWrMemData_V_s \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_comp2memWrMemData_V_s \
    op interface \
    ports { comp2memWrMemData_V_s_dout { I 512 vector } comp2memWrMemData_V_s_empty_n { I 1 bit } comp2memWrMemData_V_s_read { O 1 bit } } \
} "
}
