...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { comp2memWrMemData_V_s_din { O 512 vector } comp2memWrMemData_V_s_full_n { I 1 bit } comp2memWrMemData_V_s_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { comp2memWrStatus_V_b_din { O 8 vector } comp2memWrStatus_V_b_full_n { I 1 bit } comp2memWrStatus_V_b_write { O 1 bit } } \
} "
}
