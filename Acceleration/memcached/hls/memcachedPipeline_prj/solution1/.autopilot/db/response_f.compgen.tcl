...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { valueBuffer_rf_V_V_din { O 64 vector } valueBuffer_rf_V_V_full_n { I 1 bit } valueBuffer_rf_V_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst false \
    corename dc_metadataBuffer_rf_V_s \
    op interface \
    ports { metadataBuffer_rf_V_s_din { O 248 vector } metadataBuffer_rf_V_s_full_n { I 1 bit } metadataBuffer_rf_V_s_write { O 1 bit } } \
} "
}
