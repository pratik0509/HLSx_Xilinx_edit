...
module dummyPCIeJoint_inData_V_V_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
    ...
    // User signals
    output wire [31:0] inData_V_V_dout,
    output wire        inData_V_V_empty_n,
    input  wire        inData_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [31:0] inData_V_V_din;
wire [0:0]  inData_V_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [31:0] s_data;
...
//------------------------Instantiation------------------
// rs
dummyPCIeJoint_inData_V_V_reg_slice #(
    .N       ( 32 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// inData_V_V_fifo
dummyPCIeJoint_inData_V_V_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) inData_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( inData_V_V_empty_n ),
    .full_n     ( inData_V_V_full_n ),
    .read       ( inData_V_V_read ),
    .write      ( fifo_write ),
    .dout       ( inData_V_V_dout ),
    .din        ( inData_V_V_din )
);
...
assign inData_V_V_din = m_data[31:0];
assign fifo_full_n    = inData_V_V_full_n;
...
module dummyPCIeJoint_inData_V_V_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module dummyPCIeJoint_inData_V_V_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
