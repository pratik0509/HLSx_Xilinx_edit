set C_TypeInfoList {{ 
"dummyPCIeJoint" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inData": [[], {"reference": "0"}] }, {"outDataFlash": [[], {"reference": "0"}] }, {"outDataDram": [[], {"reference": "0"}] }, {"flushReq": [[],"1"] }, {"flushAck": [[], {"reference": "1"}] }, {"flushDone": [[],"1"] }],[],""], 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dummyPCIeJoint_mabkb_U1", "Parent" : "0"},
