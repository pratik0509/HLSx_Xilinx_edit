...
dummyPCIeJoint::dummyPCIeJoint(sc_module_name name) : sc_module(name), mVcdFile(0) {
    dummyPCIeJoint_mabkb_U1 = new dummyPCIeJoint_mabkb<1,1,6,14,14,18>("dummyPCIeJoint_mabkb_U1");
    dummyPCIeJoint_mabkb_U1->din0(grp_fu_558_p0);
    dummyPCIeJoint_mabkb_U1->din1(grp_fu_558_p1);
    dummyPCIeJoint_mabkb_U1->din2(grp_fu_558_p2);
    dummyPCIeJoint_mabkb_U1->dout(grp_fu_558_p3);
...
dummyPCIeJoint::~dummyPCIeJoint() {
    ...
    delete dummyPCIeJoint_mabkb_U1;
...
void dummyPCIeJoint::thread_ap_condition_354() {
    ap_condition_354 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_01001.read(), ap_const_boolean_0));
}

void dummyPCIeJoint::thread_ap_condition_522() {
    ap_condition_522 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0) && esl_seteq<1,4,4>(pcieState.read(), ap_const_lv4_2) && esl_seteq<1,1,1>(ap_const_lv1_1, tmp_2_fu_434_p3.read()));
}
