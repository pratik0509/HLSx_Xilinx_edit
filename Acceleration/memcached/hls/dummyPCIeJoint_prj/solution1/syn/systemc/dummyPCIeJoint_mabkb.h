...
#ifndef __dummyPCIeJoint_mabkb__HH__
#define __dummyPCIeJoint_mabkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dummyPCIeJoint_mabkb) {
    ...
    SC_CTOR(dummyPCIeJoint_mabkb):  simcore_mac_0_U ("simcore_mac_0_U") {
