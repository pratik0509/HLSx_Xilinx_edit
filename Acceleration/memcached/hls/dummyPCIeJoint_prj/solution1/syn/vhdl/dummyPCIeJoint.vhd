...
architecture behav of dummyPCIeJoint is 
    ...
    "dummyPCIeJoint,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx690tffg1157-2,HLS_INPUT_CLOCK=6.400000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=7.208000,HLS_SYN_LAT=3,HLS_SYN_TPT=1,HLS_SYN_MEM=4,HLS_SYN_DSP=1,HLS_SYN_FF=158,HLS_SYN_LUT=317,HLS_VERSION=2018_2}";
    ...
    component dummyPCIeJoint_mabkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    dummyPCIeJoint_mabkb_U1 : component dummyPCIeJoint_mabkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 6,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (((tmp_5_nbwritereq_fu_274_p3 = ap_const_lv1_0) and (tmp_8_nbwritereq_fu_282_p3 = ap_const_lv1_1) and (pcieState = ap_const_lv4_3)) or ((icmp_fu_416_p2 = ap_const_lv1_0) and (tmp_8_nbwritereq_fu_282_p3 = ap_const_lv1_1) and (pcieState = ap_const_lv4_3))))) then 
    ...
    ap_condition_354_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_01001)
    begin
                ap_condition_354 <= ((ap_const_boolean_0 = ap_block_pp0_stage0_01001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0));
    end process;


    ap_condition_522_assign_proc : process(pcieState, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_2_fu_434_p3)
    begin
                ap_condition_522 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_2_fu_434_p3 = ap_const_lv1_1) and (pcieState = ap_const_lv4_2) and (ap_const_boolean_0 = ap_block_pp0_stage0));
    end process;
    ...
    ap_phi_mux_storemerge_phi_fu_324_p4_assign_proc : process(ap_phi_reg_pp0_iter1_storemerge_reg_321, flushFlag_load_load_fu_360_p1, ap_condition_522)
    begin
    ...
    freeAddressArrayDram_1_din_assign_proc : process(pcieState, inputAddress_V, ap_predicate_op77_write_state2, tmp_V_5_fu_506_p1, ap_condition_354)
    begin
    ...
    freeAddressArrayFlas_1_din_assign_proc : process(pcieState, inputAddress_V, ap_predicate_op61_write_state2, tmp_V_7_fu_446_p1, ap_condition_354)
    begin
        if ((ap_const_boolean_1 = ap_condition_354)) then
            if ((ap_predicate_op61_write_state2 = ap_const_boolean_1)) then 
