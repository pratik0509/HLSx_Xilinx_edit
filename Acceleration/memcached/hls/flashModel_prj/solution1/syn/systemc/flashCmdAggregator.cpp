...
flashCmdAggregator::flashCmdAggregator(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_ap_condition_64);
    sensitive << ( ap_start );
    sensitive << ( ap_done_reg );
    ...
    sc_trace(mVcdFile, ap_condition_64, "ap_condition_64");
#endif
...
void flashCmdAggregator::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
        } else if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0))) && 
...
void flashCmdAggregator::thread_ap_block_state1() {
    ap_block_state1 = (esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0)));
...
void flashCmdAggregator::thread_ap_condition_64() {
    ap_condition_64 = (!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()));
}

void flashCmdAggregator::thread_ap_done() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0))) && 
...
void flashCmdAggregator::thread_flashAggregateMemCmd_1_din() {
    if (esl_seteq<1,1,1>(ap_condition_64.read(), ap_const_boolean_1)) {
...
void flashCmdAggregator::thread_flashAggregateMemCmd_1_write() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
          ...
          !(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op9_read_state1.read(), ap_const_boolean_1)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(tmp_nbreadreq_fu_36_p3.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(flashAggregateMemCmd_1_full_n.read(), ap_const_logic_0)))) || 
