set C_TypeInfoList {{ 
"flashModel" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"rdCmdIn": [[], {"reference": "0"}] }, {"rdDataOut": [[], {"reference": "1"}] }, {"wrCmdIn": [[], {"reference": "0"}] }, {"wrDataIn": [[], {"reference": "1"}] }],[],""], 
"0": [ "stream<flashMemCtrlWord>", {"hls_type": {"stream": [[[[],"2"]],"3"]}}], 
"2": [ "flashMemCtrlWord", {"struct": [[],[],[{ "address": [[], "4"]},{ "count": [[], "5"]}],""]}], 
"5": [ "ap_uint<13>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 13}}]],""]}}], 
"4": [ "ap_uint<32>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 32}}]],""]}}], 
"1": [ "stream<ap_uint<64> >", {"hls_type": {"stream": [[[[],"6"]],"3"]}}], 
