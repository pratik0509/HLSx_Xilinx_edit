...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((flashAggregateMemCmd_1_full_n == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((wrCmdIn_V_TVALID == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (rdCmdIn_V_TVALID == 1'b0)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (flashAggregateMemCmd_1_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((flashAggregateMemCmd_1_full_n == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((wrCmdIn_V_TVALID == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (rdCmdIn_V_TVALID == 1'b0)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (flashAggregateMemCmd_1_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((((tmp_4_nbreadreq_fu_44_p3 == 1'd1) & (tmp_nbreadreq_fu_36_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state1)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    if (((~((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((flashAggregateMemCmd_1_full_n == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((wrCmdIn_V_TVALID == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (rdCmdIn_V_TVALID == 1'b0)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (flashAggregateMemCmd_1_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state1) & (ap_predicate_op9_read_state1 == 1'b1)) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((flashAggregateMemCmd_1_full_n == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((wrCmdIn_V_TVALID == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (rdCmdIn_V_TVALID == 1'b0)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (flashAggregateMemCmd_1_full_n == 1'b0))) & (tmp_nbreadreq_fu_36_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    if (((tmp_nbreadreq_fu_36_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((tmp_4_nbreadreq_fu_44_p3 == 1'd1) & (tmp_nbreadreq_fu_36_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((flashAggregateMemCmd_1_full_n == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((wrCmdIn_V_TVALID == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (rdCmdIn_V_TVALID == 1'b0)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (flashAggregateMemCmd_1_full_n == 1'b0)));
end

always @ (*) begin
    ap_condition_64 = (~((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((flashAggregateMemCmd_1_full_n == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((wrCmdIn_V_TVALID == 1'b0) & (ap_predicate_op9_read_state1 == 1'b1)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (rdCmdIn_V_TVALID == 1'b0)) | ((tmp_nbreadreq_fu_36_p3 == 1'd1) & (flashAggregateMemCmd_1_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state1));
end
