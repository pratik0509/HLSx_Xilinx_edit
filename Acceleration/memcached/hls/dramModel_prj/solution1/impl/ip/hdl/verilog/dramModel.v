...
(* CORE_GENERATION_INFO="dramModel,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx690tffg1157-2,HLS_INPUT_CLOCK=6.400000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.317500,HLS_SYN_LAT=4,HLS_SYN_TPT=1,HLS_SYN_MEM=114,HLS_SYN_DSP=0,HLS_SYN_FF=1113,HLS_SYN_LUT=307,HLS_VERSION=2018_2}" *)
