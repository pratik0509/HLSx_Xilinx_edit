...
wire   [0:0] inputWord_rdOrWr_V_l_load_fu_176_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter0_fsm_state1) & (ap_start == 1'b1))) begin
        if ((ap_predicate_op33_read_state1 == 1'b1)) begin
            memArray_V_address0 = tmp_9_i_fu_231_p1;
        end else if (((inputWord_rdOrWr_V_l_load_fu_176_p1 == 1'd0) & (memState == 1'd1))) begin
...
assign inputWord_rdOrWr_V_l_load_fu_176_p1 = inputWord_rdOrWr_V;
