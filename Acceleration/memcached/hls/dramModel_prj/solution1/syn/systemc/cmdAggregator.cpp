...
void cmdAggregator::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(tmp_reg_125.read(), ap_const_lv1_1)) || (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
  esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1))))) {
            ap_done_reg = ap_const_logic_1;
        }
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter0_fsm_state1.read()) && esl_seteq<1,1,1>(ap_predicate_op7_read_state1.read(), ap_const_boolean_1) && !(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter1_fsm_state2.read()) && 
  ((esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
    esl_seteq<1,1,1>(tmp_reg_125.read(), ap_const_lv1_1)) || 
   (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
    esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1)))) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(tmp_nbreadreq_fu_44_p3.read(), ap_const_lv1_1)) || (esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op7_read_state1.read(), ap_const_boolean_1))))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter0_fsm_state1.read()) && esl_seteq<1,1,1>(tmp_nbreadreq_fu_44_p3.read(), ap_const_lv1_1) && !(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter1_fsm_state2.read()) && 
  ((esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
    esl_seteq<1,1,1>(tmp_reg_125.read(), ap_const_lv1_1)) || 
   (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
    esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1)))) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  ...
  esl_seteq<1,1,1>(ap_predicate_op7_read_state1.read(), ap_const_boolean_1))))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter0_fsm_state1.read()) && esl_seteq<1,1,1>(tmp_nbreadreq_fu_44_p3.read(), ap_const_lv1_0) && !(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter1_fsm_state2.read()) && 
  ((esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
    esl_seteq<1,1,1>(tmp_reg_125.read(), ap_const_lv1_1)) || 
   (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
    esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1)))) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  ...
  ((esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
   ...
   (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
    esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1)))) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(tmp_nbreadreq_fu_44_p3.read(), ap_const_lv1_1)) || (esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op7_read_state1.read(), ap_const_boolean_1))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter0_fsm_state1.read()))) {
        tmp_reg_125 =  (sc_lv<1>) (wrCmdIn_V_TVALID.read());
    }
}

void cmdAggregator::thread_aggregateMemCmd_V_blk_n() {
    if (((esl_seteq<1,1,1>(tmp_reg_125.read(), ap_const_lv1_1) && 
...
void cmdAggregator::thread_aggregateMemCmd_V_din() {
    if (esl_seteq<1,1,1>(ap_condition_121.read(), ap_const_boolean_1)) {
        ...
        } else if (esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1)) {
...
void cmdAggregator::thread_aggregateMemCmd_V_write() {
    if (((esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter1_fsm_state2.read()) && 
          !(esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
  esl_seteq<1,1,1>(tmp_reg_125.read(), ap_const_lv1_1)) || (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
  esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1)))) || 
...
void cmdAggregator::thread_ap_block_state1_pp0_stage0_iter0() {
    ap_block_state1_pp0_stage0_iter0 = (esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(tmp_nbreadreq_fu_44_p3.read(), ap_const_lv1_1)) || (esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op7_read_state1.read(), ap_const_boolean_1)));
}
...
void cmdAggregator::thread_ap_NS_iter1_fsm() {
    switch (ap_CS_iter1_fsm.read().to_uint64()) {
        case 2 : 
            if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(tmp_nbreadreq_fu_44_p3.read(), ap_const_lv1_1)) || (esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0) && 
  esl_seteq<1,1,1>(ap_predicate_op7_read_state1.read(), ap_const_boolean_1))) && !(esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
  esl_seteq<1,1,1>(tmp_reg_125.read(), ap_const_lv1_1)) || (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
  esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter0_fsm_state1.read()))) {
  ...
  esl_seteq<1,1,1>(tmp_reg_125.read(), ap_const_lv1_1)) || (esl_seteq<1,1,1>(ap_const_logic_0, aggregateMemCmd_V_full_n.read()) && 
  esl_seteq<1,1,1>(ap_predicate_op18_write_state2.read(), ap_const_boolean_1))) && (esl_seteq<1,1,1>(ap_const_logic_0, ap_CS_iter0_fsm_state1.read()) || 
  (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_iter0_fsm_state1.read()) && 
   (esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || 
    esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || 
    (esl_seteq<1,1,1>(wrCmdIn_V_TVALID.read(), ap_const_logic_0) && 
     esl_seteq<1,1,1>(tmp_nbreadreq_fu_44_p3.read(), ap_const_lv1_1)) || 
    (esl_seteq<1,1,1>(rdCmdIn_V_TVALID.read(), ap_const_logic_0) && 
     esl_seteq<1,1,1>(ap_predicate_op7_read_state1.read(), ap_const_boolean_1))))))) {
