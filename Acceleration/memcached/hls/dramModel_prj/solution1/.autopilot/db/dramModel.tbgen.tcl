set C_TypeInfoList {{ 
"dramModel" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"rdCmdIn": [[], {"reference": "0"}] }, {"rdDataOut": [[], {"reference": "1"}] }, {"wrCmdIn": [[], {"reference": "0"}] }, {"wrDataIn": [[], {"reference": "1"}] }],[],""], 
"0": [ "stream<memCtrlWord>", {"hls_type": {"stream": [[[[],"2"]],"3"]}}], 
"2": [ "memCtrlWord", {"struct": [[],[],[{ "address": [[], "4"]},{ "count": [[], "5"]}],""]}], 
"5": [ "ap_uint<8>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 8}}]],""]}}], 
"4": [ "ap_uint<32>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 32}}]],""]}}], 
"1": [ "stream<ap_uint<512> >", {"hls_type": {"stream": [[[[],"6"]],"3"]}}], 
"6": [ "ap_uint<512>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 512}}]],""]}}],
"3": ["hls", ""]
}}
